...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--rotation",
        type=str,
        help="Rotation to apply to the model. Example: x-90, y90, z180",
        default=None,
    )
    parser.add_argument(
        "--elevate", action="store_true", help="Elevate the model", default=False
    )
    parser.add_argument(
        "--create_pcd",
        action="store_true",
        help="Create a PCD file from the model",
        default=True,
    )
